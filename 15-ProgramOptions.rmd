...
- `r keys("DELETE")`—removes the selected item(s) from the list.
- `r keys("INSERT")`—edits the selected item in the list. Double-clicking an item with the mouse will also edit it.
- `r keys("CTRL")`+`r keys("INSERT")` (`r macOSCmdButton()`+`r keys("INSERT")` on macOS) —adds a new item to the list.
