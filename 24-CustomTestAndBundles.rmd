...
To create a custom test, go to the **Readability** tab, click the arrow beneath the `r keyboardButton("Custom Tests")` button and select **Add Test...** from the menu. At this point, the **Add Custom Test** dialog will be displayed:
...
So, to use MLA footnotes, we have to create psuedo footnotes below the table.
-->
...
| MiniWordCount() | Returns the number of miniwords (refer to [EFLAW](#eflaw-test)). |
...
From the **Readability** tab, click the `r keyboardButton("Custom Test")` button and then select **Add Test...** to display the **Add Custom Test** dialog. This dialog is used to edit or create a [custom test](#creating-custom-test).
...
To access the test bundles, select the **Readability** tab and click the `r keyboardButton("Bundles")` button. A menu will appear which contains all the available bundles, as well as options to add, edit, and remove them.
