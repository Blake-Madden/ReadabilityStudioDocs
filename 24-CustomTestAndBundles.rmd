...
To view the available functions, click the function browser button `r keys('ƒx')` to display the **Function Browser** dialog:
...
**Include Stocker's Catholic supplement**: Check this option to include [Stocker's supplementary word list](#stocker-catholic-supplement)\index{Stocker's Catholic Supplement} for Catholic students (along with any other selected word lists) to determine if a word is familiar.
