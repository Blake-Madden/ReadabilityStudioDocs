...
`r BeginNoteSection()`
`r MarkdownSectionFormatLabel("**Dale-Chall** and **Harris-Jacobson** familiar word functions will take their respective test's text exclusion options into account.")`
`r EndSection()`
...
`r BeginWarningSection()`
`r MarkdownSectionFormatLabel("This option is only recommended for when you want to find words that appear within a union of your word list and a standard list(s) (e.g., **Spache**).")`
`r EndSection()`
