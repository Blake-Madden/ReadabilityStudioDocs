...
| Function | Description |
| --- | --- |
| CharacterCount() | Returns the number of characters (i.e., letters and numbers) from the document. This function takes an argument specifying which text exclusion method to use: `Default`, [`DaleChall`](#options-dale-chall)^1^, and `HarrisJacobson`^2^. | 
...
| SentenceCount() | Returns the number of sentences from the document. This function takes an argument specifying which text exclusion or sentence-counting method to use: `Default`, `DaleChall`, `HarrisJacobson`, and `GunningFog`^3^. |
| SyllableCount() | Returns the number of syllables from the document. This function takes an argument specifying which numeral syllabizing method to use: `Default`, `NumeralsFullySyllabized`, and `NumeralsAreOneSyllable`. |

Table: Document Statistics Functions

^1^ ~Uses the Dale-Chall text-exclusion method~

^2^ ~Uses the [Harris-Jacobson text-exclusion method](#options-harris-jacobson)~

^3^ ~Uses the [Gunning Fog](#options-gunning-fog) sentence-counting method. This will be either traditional sentence counting or unit counting~
```
...
| UniqueUnfamiliarWordCount() | Returns the number of unique unfamiliar words (from a custom list) from the document.  This function takes an argument specifying which numeral syllabizing method to use: `Default` and `NumeralsFullySyllabized`. |
| UniqueThreeSyllablePlusWordCount() | Returns the number of unique words consisting of three or more syllables from the document. This function takes an argument specifying which numeral syllabizing method to use: `Default` and `NumeralsFullySyllabized`. |
| UniqueWordCount() | Returns the number of unique words from the document. |
| WordCount() | Returns the number of words from the document. This function takes an argument specifying which text exclusion method to use: `Default`, `DaleChall`, and `HarrisJacobson`. |
