...
| MiniWordCount() | Returns the number of miniwords (refer to ch. \@ref(eflaw-test)). |
...
![](Images/NonGenerated/FunctionBroswerButton.png)  Click this button to display the **Function Browser** dialog. In this dialog, you can browse the available functions and insert them into your formula. Refer to \@ref(custom-test-functions) for a list of available functions.
