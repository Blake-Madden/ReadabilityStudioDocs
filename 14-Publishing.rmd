...
To export any window, go to the **Home** tab and click the `r keyboardButton("Save")` button, or right click on the window and select **Save**.
...
Select **Export All** from the `r keyboardButton("Save")` button's menu to display the **Export All Options** dialog.
...
To print any window, go to the **Home** tab and click the `r keyboardButton("Print")` button, or right click on the window and select **Print**.

Clicking the arrow beneath the `r keyboardButton("Print")` button will open a menu containing additional printing options. For example, to change the paper size or orientation of your printouts, select **Page Setup** from this menu:
...
```{block, type='notesection'}
The preview option is only available on Windows. On macOS, the preview option on the print dialog can be used for previewing.
```
...
To do this, click on the **Home** tab of the ribbon, click on the arrow below the `r keyboardButton("Save")` button, and select **Export Filtered Document**. After excluding incomplete sentences from your document, you will be presented with additional options. Once you have specified your filtering options, the **Preview Filtered Document** dialog (shown below) will display a preview:
...
asciiData <- tibble("Extended\nASCII Character" = c("ö", "ü", "ä", "ß", "ñ",
                    ...
                    "Replacement" = c("oe", "ue", "ae", "ss", "nn",
                                      ...
                                      "i", "i", "o", "o", "o",
                                      "o", "o", "u", "u", "u"),
                    "Extended\nASCII Character " = c("ý", "ÿ", "•", "‚", "‹",
                                                    "›", "‘", "’", "`", "„",
                                                    "“", "”", "«", "»", "…",
                                                    "‒", "–", "—", "―", "©",
                                                    "®", ifelse(knitr::is_latex_output(), "\\textsuperscript{TM}", "<sup>TM</sup>"), "¼", "½", "¾",
                                                    "±", "", "", "", "" ),
                    "Replacement " = c("y", "y", verbatim("·"), verbatim("'"), verbatim("'"),
                                       verbatim("'"), verbatim("'"), verbatim("'"), verbatim("'"), verbatim("\""),
                                       verbatim("\""), verbatim("\""), verbatim("\""), verbatim("\""), verbatim("..."),
                                       verbatim("--"), verbatim("--"), verbatim("--"), verbatim("--"), "(c)",
                                       "(r)", "(tm)", "1/4", "1/2", "3/4",
                                       "+-", "", "", "", ""))
