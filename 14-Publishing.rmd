...
All graphs\index{graphs!saving}, lists\index{lists!saving}, statistical summaries\index{summaries!saving}, and highlighted text windows\index{text windows!saving} can be exported from **Readability Studio**. This is useful for reviewing the results outside the program, as well as publishing and sharing them with colleagues.
...
When [exporting](#exporting) a text window\index{text windows!saving}, the following export formats are available:
...
All graphs\index{graphs!printing}, lists\index{lists!printing}, statistical summaries\index{summaries!printing}, and highlighted text windows\index{text windows!printing} can be printed from **Readability Studio**. This is useful for reviewing the results outside the program, and for publishing and sharing them with colleagues.
