...
**Export text windows as**: Select the file type that you want to save text reports as from this list. This option only applies to standard projects, and when exporting as separate files.
...
**Include lists and text windows**: Select this option to include lists and highlighted text reports in the output. It is recommended to unselect this option for larger documents. This option only applies to standard projects.
...
::: {.center data-latex=""}
![](Images/NonGenerated/printpreview.png){width=75%}
:::
