...
`r TipSection("If you plan to edit this output, then **RTF** is recommended. (Most word processors support editing this format.)")`
...
`r TipSection("Which incomplete-sentence removal method used is controlled by your project's text exclusion options.")`
