...
To begin, click the `r keyboardButton("New")` button on the **Home** tab to display the **New Project** dialog. This dialog enables you to create either a [standard](#creating-standard-project) or [batch](#creating-batch-project) project. Note that batch projects are only available with **Professional Edition**.
...
::: {.center data-latex=""}
![](Images/selectdirectory.png){width=50%}
:::
...
::: {.center data-latex=""}
![](Images/selectarchive.png){width=50%}
:::
