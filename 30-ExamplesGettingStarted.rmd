...
Close this document and return to *Readability Studio*. Click the `r keys('Example Documents')` button and again select *Summer Code Camp*. Next, select **Create a new project**. When the **New Project Wizard** appears, select the **Document Structure** page and check **Non-narrative, fragmented text**:
