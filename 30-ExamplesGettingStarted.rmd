...
You will then return to the **Document** page. Click the **Forward** button to proceed to the **Test Selection** dialog, as shown below:
...
Our recipe file does not have any special formatting (e.g., text centering), so keep both options in the **Layout** section unchecked. Now that we have specified the structure of the document, click the **Forward** button to proceed to the **Test Selection** page, as shown below:
...
Next, accept the rest of the defaults on the **New Project** wizard by clicking the **Finish** button. Once the project is finished loading, click on the **View Document** icon to display the highlighted content of the webpage.
...
Next, let's put a [watermark](#watermark-and-logo) across our graph. Click the **Watermark** button in the **Edit** section. Enter the following into the **Watermark** dialog and click **OK**:
