...
`r BeginNoteSection()`
`r MarkdownSectionFormatLabel("The language option is only available in the **Language Pack** and **Professional** editions of **Readability Studio**.")`
`r EndSection()`
...
`r BeginNoteSection()`
`r MarkdownSectionFormatLabel("The original and revised versions of this recipe are available from the **Example Documents** menu. From the **Help** tab, click the **Example Documents** button and then select either **Cocoa Desserts** or **Cocoa Desserts (Revised)** from the menu. When prompted about how to open the document, select **Create a new project**.")`
`r EndSection()`
...
`r BeginTipSection()`
`r MarkdownSectionFormatLabel("You can click the **Reload** button at anytime to reanalyze the source document as you edit it externally. Also, whenever you open this project, it will automatically reload the source document (in this case the recipe file).")`
`r EndSection()`
