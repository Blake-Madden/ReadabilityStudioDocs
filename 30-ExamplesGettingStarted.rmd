...
`r TipSection("You can click the **Reload** button at anytime to reanalyze the source document as you edit it externally. Also, whenever you open this project, it will automatically reload the source document (in this case the recipe file).")`
...
`r TipSection("Entering “[DATE]” in the watermark will show the current date when the graph is rendered.")`
