...
To do this, click the **Save** button on the **Home** tab and use the **Save As...** dialog to save this list to either an HTML or text file. You can also do this with any of the other difficult word lists, such as the **Spache unfamiliar words** list. Refer to the [Improving Students' Vocabulary](#VocabBuilderExample) example for further details.

## Improving Students' Vocabulary {-#VocabBuilderExample}
...
Continuing from the [previous example](#book-example), select the top item in the hard word list. Now scroll down to the last word that has five syllables, hold down the `SHIFT` key, and select this word. Now you will have all the words with five or more syllables selected. If there are any words that you want to add or remove from your selection, hold down the `CTRL` key and click on them. Your word list will look like this:
...
The original and revised versions of this recipe are available from the **Example Documents** menu. From the **Help** tab, click the **Example Documents** button and then select either **Cocoa Desserts** or **Cocoa Desserts (Revised)** from the menu.
:::
...
The first step is to open the example file **Features**. From the **Help** tab, click the **Example Documents** button and then select **Features** from the menu.
