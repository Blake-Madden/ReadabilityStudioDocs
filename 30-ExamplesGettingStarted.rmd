...
To do this, click the `r keyboardButton("Save")` button on the **Home** tab and use the **Save As...** dialog to save this list to either an HTML or text file. You can also do this with any of the other difficult word lists, such as the **Spache unfamiliar words** list. Refer to \@ref(vocab-builder-example) for an example.
