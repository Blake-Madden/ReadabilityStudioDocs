...
Note that you can always reload a project manually by clicking the `r keyboardButton("Reload")` button on the **Home** tab of the ribbon. This is useful when you are editing the source document from another program and want to refresh the results in **Readability Studio**.