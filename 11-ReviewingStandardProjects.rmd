...
To remove any test from this list, select it and press `CTRL+DELETE` (`⌘+DELETE` on macOS) on your keyboard. To edit a [custom test](#creating-custom-test), double click on it in this list. To view the help for a standard test, double click on it in this list.
...
```{r, echo=F, fig.cap='Gilliam-Peña-Mountain Graph', fig.align='center'}
...
```{r, echo=F, fig.cap='Schwartz Graph', fig.align='center'}
...
```{r, echo=F, fig.cap='Frase Graph', fig.align='center'}
...
```{r, echo=F, fig.cap='Crawford Graph', fig.align='center'}
...
```{r, echo=F, fig.cap='Flesch Chart', fig.align='center'}
...
```{r, echo=F, fig.cap='Danielson Bryan 2 Plot', fig.align='center'}
knitr::include_graphics("Images/DB2Plot.png")
```

Similar to a **Flesch** chart, the **Lix** guage plots a document's **Lix** index score on a chart showing its difficulty level:

```{r, echo=F, fig.cap='Lix Guage', fig.align='center'}
knitr::include_graphics("Images/LixGuage.png")
```

In the above chart, we can see that **Lix** scores can range from 0 (“very easy”) to 60+ (“very difficult”).

There is also a variation of the **Lix** guage that is adjusted for German materials:

```{r, echo=F, fig.cap='German Lix Guage', fig.align='center'}
knitr::include_graphics("Images/GermanLixGuage.png")
```

This version adjusts the scaling of the score, assuming that German text is inheriently more difficult than other languages. It also includes additional levels of difficulty (e.g., “children and young adult”).
...
```{r, echo=F, fig.cap='Multiple documents on a Fry Graph', fig.align='center'}
