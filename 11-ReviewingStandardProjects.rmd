...
There will also be graphs in this section if you had included the [*Fry*](#reviewing-readability-graphs) , [*Gilliam-Peña-Mountain*](#gilliam-pena-mountain-fry-graph), [*Raygor*](#reviewing-readability-graphs), [*Flesch*](#flesch-test), or [*FRASE*](#frase) tests. Refer to \@ref(reviewing-readability-graphs) for further information.
