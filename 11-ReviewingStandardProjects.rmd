...
To remove any test from this list, select it and press `r keys("CTRL")`+`r keys("DELETE")` (`r macOSCmdButton()`+`r keys("DELETE")` on macOS) on your keyboard. To edit a [custom test](#creating-custom-test), double click on it in this list. To view the help for a standard test, double click on it in this list.
...
To find a specific word in a list, type the word into the **Search** bar at the top of program and hit the `r keys("ENTER")` button on your keyboard. You can also select the list and begin typing the word. If the word is in the list, then the selection will move to it.
...
To add a word(s) to your dictionary, first select them in this list. Then, click on the **Document** tab, and click the arrow below the `r keys("Spell Checker")` button. Then, select **Add Selected Words** and the selected words in this list will no longer be reported as misspellings.

To edit your custom dictionary, click on the arrow beneath the `r keys("Spell Checker")` button and select **Edit...** to show the **Edit Custom Dictionary** dialog. From here, you can add, remove, or edit the words in your custom dictionary.

To change your spell-checking options, click on the arrow beneath the `r keys("Spell Checker")` button and select **Settings...** to edit your [grammar](#options-grammar) settings.
