...
Refer to ch. \@ref(repeated-word-exceptions) for more information on how repeated words are detected.
...
Refer to ch. \@ref(article-mismatching) to learn more.
...
The **Dolch Coverage** graph displays how much of each category is used in the document. Refer to ch. \@ref(reviewing-dolch-stats) for more information.
...
The **Words Breakdown** graph displays all the raw **Dolch** word counts, broken down by category. Refer to ch. \@ref(reviewing-dolch-stats) for more information.
