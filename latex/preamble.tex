...
% to create a "see also" that appears at the bottom of the list
% of subentries and with no page number, do the following:
% \index{Main Entry!\lastentry@\seealsonocomma{Other item}|nopage}
\def\seealsonocomma#1#2{{\em see also\/} #1} % the #2 consumes a comma
\def\nopage#1{} % consume the page number
\def\lastentry{zzzzzzz}
