...
Judging from this graph, we have quite a few difficult documents in this batch. There are 11 files in the 12-13 range, which is not a comfortable reading level. Refer to ch. \@ref(reviewing-batch-histograms) and [Reviewing the box plots](#reviewing-batch-box-plots) for further information.
