...
For this example, we will use the [Flesch](#flesch-test)\index{Flesch Reading Ease!creating a custom variant} formula for our basis. We will take the standard Flesch formula and substitute its sentence count factor with independent clause count. This will effectively create a formula which does not penalize documents for containing numerous compound sentences.
