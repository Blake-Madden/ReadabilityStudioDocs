...
The log's level of detail is controlled by either the [command line](#command-line-options) or by holding down the `r keyboardButton("SHIFT")` button on your keyword while the program starts. (Holding `r keyboardButton("SHIFT")` instructs the program to use maximum, verbose logging.)
