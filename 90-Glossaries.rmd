...
`r os_logo('windows')`: shortcut on Windows

`r os_logo('apple')`: shortcut on macOS

Table: Application Level Shortcuts
...
+-----------------------------------------+------------------------------------------------------+
| Enable verbose logging                  | Hold down `r keys("Shift")` `r os_logo('windows')`\ or `r keys("\\shift")` `r os_logo('apple')`\ |
|                                         | while the program is loading                         |
+-----------------------------------------+------------------------------------------------------+

Table: Project Operations Shortcuts
