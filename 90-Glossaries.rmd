...
| To do this                              | Press                                                |
+:========================================+:=====================================================+
| Enable verbose logging                  | Hold the `r keys("Shift")` `r os_logo('windows')`\   |
|                                         | or\                                                  |
...
:::
::: {.glsdef data-latex=''}
A [cloze](#cloze) procedure is a test given to readers to measure their comprehension ability. Refer to \@ref(cloze) for further details.
:::
::::
