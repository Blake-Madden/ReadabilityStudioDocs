...
+---------------------------+------------------------------------------------------------------+
| Create a new project from | `r keys('CTRL')`+`r keys('V')` `r os_logo('windows')`\           |
| content on the clipboard  |  or\                                                             |
|                           | `r macOS_cmd_key()`+`r keys('V')` `r os_logo('apple')`           |
+---------------------------+------------------------------------------------------------------+
| Save the active project   | `r keys('CTRL')`+`r keys('S')` `r os_logo('windows')`\           |
|                           |  or\                                                             |
|                           | `r macOS_cmd_key()`+`r keys('S')` `r os_logo('apple')`           |
+---------------------------+------------------------------------------------------------------+
| Print the active window   | `r keys('CTRL')`+`r keys('P')` `r os_logo('windows')`\           |
|                           |  or\                                                             |
|                           | `r macOS_cmd_key()`+`r keys('P')` `r os_logo('apple')`           |
+---------------------------+------------------------------------------------------------------+
