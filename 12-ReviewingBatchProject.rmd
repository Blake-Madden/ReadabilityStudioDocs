...
Continuing on, this batch has quite a few difficult documents. There are 21 documents in the 8^th^-9^th^ grade range, 22 documents in the 10^th^-11^th^ grade range, etc. In contrast, there are few easy documents, with only 2 in the 6^th^-7^th^ grade range and only 1 in the 2^nd^-3^rd^ and 4^th^-5^th^ ranges. From this, we can surmise that the readability of this batch needs improving.
