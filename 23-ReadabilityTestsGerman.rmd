...
kableExtra::kbl(nws1Data, booktabs=T, centering=T, align='l', escape=F) %>%
  ...
  footnote(number = c(markdownForKableFootnote('“*drei- und mehrsilbigen*”'),
                      markdownForKableFootnote('“*mehr als sechs buchstaben*”'),
                      markdownForKableFootnote('“*einsilbigen*”')),
