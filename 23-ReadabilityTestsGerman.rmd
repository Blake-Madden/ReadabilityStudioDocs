...
```{r, echo=F}
amstadConversionTable <- read_delim("data/AmstadConversionTable.txt", 
    "\t", escape_double = F, trim_ws = T)

kableExtra::kbl(amstadConversionTable, booktabs=T, centering=T, linesep="",
                caption="Amstad Conversion Table", align='l', escape=F)
```
