...
`r BeginNoteSection()`
`r MarkdownSectionFormatLabel("Like **Flesch Reading Ease**, this test treats numerals as monosyllabic words by default. This behavior can be changed from the **Readability Options** dialog.")`
`r EndSection()`
...
`r BeginNoteSection()`
`r MarkdownSectionFormatLabel("Based on the examples from **Bamberger-Vanecek** (78), the grade-level score should be truncated to one-point precision, not rounded.")`
`r EndSection()`
...
`r BeginNoteSection()`
`r MarkdownSectionFormatLabel("Although **Bamberger-Vanecek** (77, 186) does not specify using units instead of sentences, the use of units is assumed to match **Wheeler-Smith**.
