...
[Lix](#lix-test)\index{Lix!scoring method} and [Rix](#rix-test)\index{Rix!scoring method} use a similar method. These tests calculate an index score and then look up the grade level from a table using this value.
