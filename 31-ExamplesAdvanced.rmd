...
`r BeginTipSection()`
`r MarkdownSectionFormatLabel("All the options discussed here are also available on the **Document** tab of the ribbon.")`
`r EndSection()`
...
`r BeginTipSection()`
`r MarkdownSectionFormatLabel("All the options discussed here are also offered on the **Document** tab of the ribbon.")`
`r EndSection()`
