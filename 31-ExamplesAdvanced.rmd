...
[Test bundles](#test-bundles) are a convenient way to add multiple tests to a project at once. In this example, we will create a test bundle named “4F” which includes the [*Fry*](#fry-test), [*FORCAST*](#forcast-test), [*Fog*](#gunning-fog-test), and [*Flesch-Kincaid*](#flesch-kincaid-test) tests. The first step is to select the **Readability** tab, click the `r keyboardButton("Bundles")` button, and select **Add...** from the menu. This will open the **Add Test Bundle** dialog:
