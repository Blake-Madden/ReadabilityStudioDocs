...
- Improved appearance of **Test Bundle** dialog.
...
- Loading a spreadsheet into batch project can now import each cell as either a document or a filepath.
...
- Improvements to HTML importer when file contains malformed title, style, and script sections.
