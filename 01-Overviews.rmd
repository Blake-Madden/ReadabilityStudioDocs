...
`r BeginNoteSection()`
`r MarkdownSectionFormatLabel("Spanish and German tests are only available in the **Professional** edition, or if you have the **Language Pack** feature licensed.")`
`r EndSection()`
