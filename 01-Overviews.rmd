...
englishTests <- splitColumnIntoTable(read_tsv("data/EnglishTests.txt",
                                     col_names=F)[[1]], maxTestRows, "Tests")
...
```{r, echo=F}
spanishTests <- splitColumnIntoTable(read_tsv("data/SpanishTests.txt",
                                     col_names=F)[[1]], maxTestRows, "Tests")
...
```{r, echo=F}
germanTests <- splitColumnIntoTable(read_tsv("data/GermanTests.txt",
                                    col_names=F)[[1]], maxTestRows, "Tests")
