...
The options made available will be dependent on the graph type. Please refer to ch. \@ref(options-box-plots) for further discussions of these options.

Please refer to \@ref(customizing-a-graph) for a step-by-step tutorial on editing a graph.
