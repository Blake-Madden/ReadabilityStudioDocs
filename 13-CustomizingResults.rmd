...
Click the `r keyboardButton("Edit Report")` button to view the [**Properties**](#options-statistics) dialog. Here, you can specify which sections to include in your summary report.
...
To sort a list by multiple columns, click the `r keyboardButton("Sort")` button in the **Edit** section on the **Home** tab of the ribbon and the **Sort Columns** dialog will appear:
